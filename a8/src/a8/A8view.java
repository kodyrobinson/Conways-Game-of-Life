...
public class A8view extends JPanel implements ActionListener, SpotListener {
	...
	public A8view(int dimensions) {
		...
		add(new JLabel("The thresholds for the birth and survival requirements can be set by adjusting the corresponding variables in the Main.java program."), BorderLayout.NORTH);
